...
export class AllTablesAdded1720368921099 implements MigrationInterface {
    name = 'AllTablesAdded1720368921099'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "stakes" ADD CONSTRAINT "FK_c0ba671b31c1cb1c0502b9d22fa" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
